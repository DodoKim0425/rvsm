...
public class ChartActivity extends AppCompatActivity {
    ...
    void connect(){//연결함수
        ...
        try {
            ...
            mSocket.on("get_data", new Emitter.Listener() {//데이터 받는 이벤트
                @Override
    ...
    void get_data(){
        ...
        mSocket.emit("and_connected",data);//서버에 데이터 요청
    ...
    private void drawGraph(){//그래프를 그린다
        try{
            ...
            dataSet3.setColor(Color.parseColor("#9560FF"));
            ...
            lineChart.setVisibleXRangeMaximum(20);//한 그래프위에 20개의 데이터만 보이도록함
